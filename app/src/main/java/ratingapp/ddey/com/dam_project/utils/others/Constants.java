...
public interface Constants {
    ...
    //SHARED PREFERENCES (SESSION CONSTANTS)
    String PREFER_NAME = "myQuizApp";
    String IS_USER_LOGIN = "IsUserLogged";
    ...
    int REQUEST_CODE_GALLERY_UPLOAD_PHOTO = 9;
    ...
    //TXT CONSTANTS
    String TXT_FILE_NAME = "myQuizHistory.txt";
